...
async function sendVerificationEmail(recipient_email, OTP) {
  ...
  const mg = mailgun.client({
    ...
    try {
        ...
        to: recipient_email,
        subject: "Your DePaul Climbing verification code",
        text: `Hi,

Use the following code to complete verification. This code is valid for 5 minutes.
...
This is an automated message from DePaul Climbing (depaulclimbing.com). Please do not reply to this email.`,
        ...
        html:`<!DOCTYPE html>
            ...
            <title>DePaul Climbing - Verification Code</title>


            </head>
            <body style="margin:0;padding:0;background-color:#f4f4f4;">
            <!-- partial:index.partial.html -->
            <div style="font-family: Helvetica,Arial,sans-serif;line-height:1.6;color:#222222;max-width:480px;margin:0 auto;padding:24px;">
                <div style="border-bottom:1px solid #eee;padding-bottom:12px;margin-bottom:16px;">
                <span style="font-size:1.3em;color: #00466a;font-weight:600">DePaul Climbing</span>
                </div>
                <p>Hi,</p>
                <p>Use the following code to complete verification. This code is valid for 5 minutes.</p>
                <p style="text-align:center;margin:24px 0;">
                <span style="display:inline-block;background: #00466a;color: #fff;font-size:1.5em;letter-spacing:4px;padding:10px 20px;border-radius:4px;">${OTP}</span>
                </p>
                <p>If you did not request this code, you can safely ignore this email.</p>
                <p style="font-size:0.9em;">Regards,<br />DePaul Climbing</p>
                <hr style="border:none;border-top:1px solid #eee;margin-top:24px;" />
                <p style="font-size:0.75em;color:#999999;">This is an automated message from DePaul Climbing (depaulclimbing.com). Please do not reply to this email.</p>
            </div>
            <!-- partial -->
